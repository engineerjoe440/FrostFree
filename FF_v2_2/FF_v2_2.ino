...
Description:
  This code is designed to operate an Arduino-based control system for the FF-2.2 produced by Stanley Solutions.
...
Design:
  This design was created by Joe Stanley for the FrostFree: Stanley Solutions FF-2.2.
  Solely for use in FF-2.2
  
Update:
  This project was last updated:  04/17/2017
  Version:   FF-2.2
