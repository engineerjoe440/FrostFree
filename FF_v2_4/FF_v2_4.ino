...
Description:
  This code is designed to operate an Arduino-based control system for the FF-2.4 produced by Stanley Solutions.
...
Version 2 Update:
  ...
  FF-2.4 Fixes include:
     -Voltage measurement correction
        +Threshold based logic
        +Corrected decision values
     -MOSFET false detection
        +Increased time delay
  
Design:
  This design was created by Joe Stanley for the FrostFree: Stanley Solutions FF-2.4.
  Solely for use in FF-2.4
  
Update:
  This project was last updated:  10/01/2017
  Version:   FF-2.4
  This project has not been released for prototype service.
  This project's status is: Inactive Prototype.
...
// Define voltage test thresholds
#define ONvolt 8200
#define OFFvolt 7400
...
boolean radio_operate( int command )
{
  ...
  time_delay(5000);               // Wait for chatter to stop and RC constant
...
void alternator_connect(void)
{
  ...
  // When the voltage is greater than ON threshold, start charging
  if(voltage > ONvolt)
  {
